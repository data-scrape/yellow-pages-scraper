...
> Scrape Yellow Pages business listings - phone, address, reviews

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/yellow-pages-scraper?style=flat-square)](https://github.com/data-scrape/yellow-pages-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/yellow-pages-scraper?style=flat-square)](https://github.com/data-scrape/yellow-pages-scraper/forks)
...
**Yellow Pages Scraper** is a free, open-source Python scraper for **Yellow Pages**. Extract structured data from yellow pages with full pagination support, proxy rotation, and multiple export formats.

yellow pages scraper, scrape yellow pages, yp scraper

## ✨ Features

- ✅ Business name & phone extraction
- ✅ Address & category data
- ✅ Business ratings & reviews
- ✅ Website & social links
- ✅ Hours of operation
- ✅ Bulk city/category search
...
```bash
python scraper.py "Plumbers in Chicago, IL"
```
...
`business_name` | `phone` | `address` | `city` | `state` | `zip` | `category` | `rating` | `review_count` | `website` | `hours` | `years_in_business` | `url`
